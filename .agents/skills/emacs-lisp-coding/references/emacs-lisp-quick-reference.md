...
A concise reference for Emacs Lisp patterns, naming conventions, and common
idioms based on community best practices.
...
- [Common Requires](#common-requires)
...
- [Defining Modes](#defining-modes)
- [Macros](#macros)
- [Error Handling](#error-handling)
- [Advice](#advice)
- [Common Idioms](#common-idioms)
- [Interactive Codes Quick Reference](#interactive-codes-quick-reference)
...
```elisp
(require 'cl-lib)  ; cl-loop, cl-defun, cl-case, cl-evenp
(require 'seq)     ; seq-filter, seq-reduce, seq-do
