...
syntax. `#[non_exhaustive]` forces external code to use wildcards in matches and
constructors, allowing you to add variants/fields in minor versions without
breaking callers.
...
- [api-builder-pattern](./api-builder-pattern.md) - Alternative to struct
  literals
