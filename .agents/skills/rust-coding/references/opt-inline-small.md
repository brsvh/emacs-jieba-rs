...
Function call overhead (stack frame setup, register saves, jumps) can dominate
small functions. Inlining eliminates this overhead and enables further
optimizations by the compiler. The compiler often inlines automatically, but
hints help for cross-crate calls.
...
- [opt-inline-always-rare](opt-inline-always-rare.md) - Use #[inline(always)]
  sparingly
- [opt-inline-never-cold](opt-inline-never-cold.md) - Use #[inline(never)] for
  cold paths
