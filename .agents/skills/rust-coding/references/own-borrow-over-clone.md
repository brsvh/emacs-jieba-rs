...
Cloning allocates new memory and copies data, while borrowing is free.
Unnecessary clones can significantly impact performance, especially in hot paths
or with large data structures.
...
- [own-slice-over-vec](own-slice-over-vec.md) - Accept slices instead of
