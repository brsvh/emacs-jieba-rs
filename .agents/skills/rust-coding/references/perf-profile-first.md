...
Intuition about performance is often wrong. The code you think is slow
frequently isn't, while actual bottlenecks hide in unexpected places. Profiling
shows you exactly where time is spent, preventing wasted effort on optimizations
that don't matter.
...
> "It is worth understanding which Rust data structures and operations cause
...
- [test-criterion-bench](test-criterion-bench.md) - Use criterion for
  benchmarking
- [anti-premature-optimize](anti-premature-optimize.md) - Don't optimize without
  data
