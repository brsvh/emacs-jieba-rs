...
When a value can be in exactly one of several states, an enum makes invalid
states unrepresentable. The compiler ensures all states are handled. Contrast
with boolean flags or optional fields that can represent impossible
combinations.
...
- [pat-exhaustive-enum](./pat-exhaustive-enum.md) - Match owned enums
  exhaustively
- [serde-enum-representation](./serde-enum-representation.md) - Choose enum wire
  tagging
