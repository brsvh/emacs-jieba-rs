...
A validated newtype guarantees its inner value is always valid. Once you have an
`Email`, you know it passed validation—no re-checking needed. This "parse, don't
validate" pattern catches errors at boundaries and makes invalid states
unrepresentable.
...
- [conv-fromstr-parsing](./conv-fromstr-parsing.md) - FromStr for validated
  parsing
- [serde-try-from-validate](./serde-try-from-validate.md) - Validate during
  deserialization
